...
public:
	...
	bool			IsPrivateGame();
	void			HostGame(int localUsersMask, bool bOnlineGame, bool bIsPrivate, unsigned char publicSlots = (unsigned char)(MINECRAFT_NET_MAX_PLAYERS & 0xFF), unsigned char privateSlots = 0);
	bool			IsHost();
