...
public:
	...
	virtual void HostGame(int localUsersMask, bool bOnlineGame, bool bIsPrivate, unsigned char publicSlots = (unsigned char)(MINECRAFT_NET_MAX_PLAYERS & 0xFF), unsigned char privateSlots = 0) = 0;
...
private:
	...
	virtual void _HostGame(int usersMask, unsigned char publicSlots = (unsigned char)(MINECRAFT_NET_MAX_PLAYERS & 0xFF), unsigned char privateSlots = 0) = 0;
